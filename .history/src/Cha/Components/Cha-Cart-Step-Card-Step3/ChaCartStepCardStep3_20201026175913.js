            ...
            <div className="cha-step3-5-receipt-div">
              <div className="">
                <input
                  ...
                  value="1"
                />
                <label className="cha-choice" htmlFor="cha-receipt-type_1">
                  發票捐贈
                </label>
              </div>
              <div className="cha-H-box-3">
                <input
                  ...
                  value="2"
                />
                <label className="cha-choice" htmlFor="cha-receipt-type_2">
                  二聯式電子發票
                </label>
              </div>
              <div className="cha-H-box-3">
                <input
                  ...
                  value="3"
                />
                <label className="cha-choice" htmlFor="cha-receipt-type_3">
                  三聯式電子發票
                </label>
              </div>
            </div>
