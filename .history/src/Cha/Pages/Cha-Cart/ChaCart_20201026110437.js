    ...
    <>
      ...
      <div className="cha-wrap">
        ...
        <main>
          ...
          {/* 步驟一，結束 */}
          {/* 步驟二，開始 */}
          <div className="cha-main-card main-card-step2">
            <div className="cha-step-header">步驟2：訂單資料</div>
            <form action="#" id="#">
              {/* 聯絡人姓名 */}
              <div className="cha-form-group">
                <label htmlFor="step2-1-name">聯絡人姓名</label>
                <input
                  type="text"
                  className="cha-form-control step2-1-name"
                  id="step2-1-name"
                  name="step2-1-name"
                  placeholder="請填寫姓名"
                />
              ...
              <div className="cha-form-group">
                ...
                <input
                  type="text"
                  className="cha-form-control step2-2-phone"
                  id="step2-2-phone"
                  name="step2-2-phone"
                />
              </div>
              ...
              <div className="cha-step2-take-date-time">
                <div className="cha-form-group">
                  ...
                  <input
                    type="text"
                    className="cha-form-control step2-3-take-date"
                ...
                <div className="cha-form-group">
                  ...
                  <input
                    type="text"
                    className="cha-form-control step2-4-take-time"
              ...
              <div className="cha-form-group">
                ...
                <input
                  type="text"
                  className="cha-form-control step2-5-take-address-1"
              ...
              <div className="cha-form-group">
                ...
                <input
                  type="text"
                  className="cha-form-control step2-5-take-address-2"
              ...
              <div className="cha-form-group">
                ...
                <input
                  type="text"
                  className="cha-form-control step2-5-take-address-3"
          ...
          <div className="cha-main-card main-card-step3">
            ...
            <div className="cha-Credit-Card-div">
              <div className="cha-Credit-Card-flip">
                ...
                <div className="cha-Credit-Card-all">
                  ...
                  <input
                    type="text"
                    className="cha-form-control card-3number-on-picture"
            ...
            <form action="#" id="#">
              ...
              <div className="cha-form-group">
                ...
                <input
                  type="text"
                  className="cha-form-control step3-1-card-number"
              ...
              <div className="cha-step3-MONTH-YEAR-3number">
                <div className="cha-form-group">
                  ...
                  <input
                    type="text"
                    className="cha-form-control step3-2-MONTH"
                    id="step3-2-MONTH"
                    name="step3-2-MONTH"
                  />
                </div>
                <div className="cha-form-group">
                  ...
                  <input
                    type="text"
                    className="cha-form-control cha-step3-3-YEAR"
                    id="step3-3-YEAR"
                    name="step3-3-YEAR"
                  />
                </div>
                ...
                <div className="cha-form-group">
                  ...
                  <input
                    type="text"
                    className="cha-form-control step3-4-back-3number"
              ...
              {/* <div className="cha-form-group-l-1">
