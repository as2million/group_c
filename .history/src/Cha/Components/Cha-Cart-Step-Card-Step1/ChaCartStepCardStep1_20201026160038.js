    ...
    <>
      <div className="cha-main-card cha-main-card-step1">
        <div className="cha-step-header">
          步驟1：餐點明細
          <button className="cha-normal-cart-switch cha-normal-cart-switch">訂餐購物車</button>
          <button className="cha-former-cart-switch cha-normal-cart-switch">小農購物車</button>
        </div>
