...
function ChaOrderManagement(props) {
  ...
  const TabMenu = () => {
    ...
    const tabContentA = (e) => {
      setTabActive(e.target, '.cha-order-');
      ...
      <>
        <div className="cha-order-mana-content-container col-9">
          <div className="cha-order-mana-content-row1">
            <div
              className="cha-order- active"
              onClick={tabContentA}
            >
              未送達
            </div>
            <div className="cha-order-" onClick={tabContentB}>
              已送達
            </div>
            <div className="cha-order-" onClick={tabContentC}>
              已退費
            </div>
            <div className="cha-order-" onClick={tabContentD}>
              揪團中
            </div>
          </div>
