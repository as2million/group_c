...
function ChaOrderItem(props) {
  ...
  return (
    <>
      ...
      // setOrderSidMyOrder();
      // // 訂單狀態
      // setOrderStateMyOrder();
      // // 取餐人
      // setTakePersonMyOrder(orderItem.take_person);
      // // 取餐日期
      // setTakeDateMyOrder(orderItem.take_date);
      // // 取餐時間
      // setTakeTimeMyOrder(orderItem.take_time);
      // //取餐方式
      // setTakeWayMyOrder(orderItem.take_way);
      // // 取餐地址
      // setAddressMyOrder(orderItem.take_address);
      // // 訂單金額
      // setTotalPriceMyOrder(orderItem.total_price);
      // //////////// 我的訂單明細
      // // 商品編號
      ...
      // // 訂單小計
      // setSubtotalPriceDetail(orderItem.subtotal_price);
      // // 怪獸幣
      // setBeastieCoinDetail(orderItem.beastie_coin);
      // // 運費
      // setShippingDetail(orderItem.shipping); */}
      <h1>★★我的訂單</h1>
      {/* <h1>訂單編號：AAA{orderItem.sid}</h1>
