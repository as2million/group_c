...
import ChaGroupOrderMenu from 'Cha/Components/Cha-Group-Order-Confirm/ChaGroupOrderConfirm';
      ...
      <>
        ...
        <div className="cha-group-wrap">
          ...
          <Switch>
            ...
            <Route path="/groupOrder/ChaGroupOrderConfirm">
              <ChaGroupOrderConfirm />
            </Route>
            <Route path="/chaGroupOrderMenu">
      <ChaGroupOrderMenu />
    </Route>
