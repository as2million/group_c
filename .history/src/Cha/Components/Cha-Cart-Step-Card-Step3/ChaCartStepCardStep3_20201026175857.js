          ...
          <div className="cha-step3-5-receipt-choose">
            ...
            <div className="cha-step3-5-receipt-div">
              <div className="">
                <input
                  className=""
                  id="cha-receipttype_1"
                  name="cha-receipttype"
                  type="radio"
                  value="1"
                />
                <label className="cha-choice" htmlFor="cha-receipttype_1">
                  發票捐贈
                </label>
              </div>
              <div className="cha-H-box-3">
                <input
                  ...
                  id="cha-receipttype_2"
                  name="cha-receipttype"
                  type="radio"
                  value="2"
                />
                <label className="cha-choice" htmlFor="cha-receipttype_2">
                  二聯式電子發票
                </label>
              </div>
              <div className="cha-H-box-3">
                <input
                  className="cha-margin"
                  id="cha-receipttype_3"
                  name="cha-receipttype"
                  type="radio"
                  value="3"
                />
                <label className="cha-choice" htmlFor="cha-receipttype_3">
                  三聯式電子發票
                </label>
              </div>
            </div>
