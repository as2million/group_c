...
function AddressTabs(props) {
  ...
  const ComponentA = (props) => {
    ...
    //台北市或新北市
    const [tabCounty, setTabCounty] = useState(county)
    console.log(tabCounty)
    //區域選擇狀態
    const [tabDistrict, setTabDistrict] = useState(district)
    //地址輸入部分，預設值式資料庫地址欄位
    const [tabInput, setTabInput] = useState(address)
    setAddress(tabInput)

    // if (tabCounty === '台北市') {
    // document.getElementById('taipieCity').checked = true
    // input['name' === 'city']['value' === '台北市'].attr('checked', true)
    // document.input[(name = 'city')][(value = '台北市')].attr('checked', true)
    // document.input[name = 'city'][value = '台北市'].attr('checked', true)
    // document.querySelector('#taipieCity').attr('checked', true)
    // }
    // if (tabCounty === '新北市') {
    // document.getElementById('newTaipieCity').checked = true
    // input['name' === 'city']['value' === '新北市'].attr('checked', true)
    // document.input[(name = 'city')][(value = '新北市')].attr('checked', true)
    // document.input[name = 'city'][value = '新北市'].attr('checked', true)
    // document.querySelector('#newTaipieCity').attr('checked', true)
    // }
                ...
                <div className="iris-mainpage-select-wrapper d-flex">
                  <div className="iris-selectbar-wrapper">
                    ...
                    >
                      ...
                      {townships[indexTownship ? 1 : 0].map((v, i) => (
              ...
              <div className="jan-map-results p-2 mt-4 ">
                <p>
                  ...
                  <span>
                    ...
                    {/* {tabDistrict > -1 && price[tabCounty][tabDistrict]} */}
                  </span>
                  元免運費
                </p>
              </div>
