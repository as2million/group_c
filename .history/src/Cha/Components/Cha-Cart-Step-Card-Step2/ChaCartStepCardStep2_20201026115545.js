...
function ChaCartStepCardStep2(props) {
  return (
    <>
      <div className="main-card main-card-step2">
        <div className="step-header">步驟2：訂單資料</div>
        <form action="#" id="#">
          {/* 聯絡人姓名 */}
          ...
          <div className="form-group">
            ...
            <input
              type="text"
              className=" step2-5-take-address-1"
          ...
          <div className="form-group">
            ...
            <input
              type="text"
              className=" step2-5-take-address-2"
          ...
          <div className="form-group">
            ...
            <input
              type="text"
              className=" step2-5-take-address-3"
