          ...
          <div className="cha-main-card cha-main-card-step2">
            ...
            <form action="#" id="#">
              ...
              <div className="cha-form-group">
                ...
                <input
                  type="text"
                  className="cha-form-control cha-step2-1-name"
                  id="step2-1-name"
                  name="step2-1-name"
                  placeholder="請填寫姓名"
                />
              ...
              <div className="cha-form-group">
                ...
                <input
                  type="text"
                  className="cha-form-control cha-step2-2-phone"
                  id="step2-2-phone"
                  name="step2-2-phone"
                />
              </div>
              ...
              <div className="cha-step2-take-date-time">
                <div className="cha-form-group">
                  ...
                  <input
                    type="text"
                    className="cha-form-control cha-step2-3-take-date"
                ...
                <div className="cha-form-group">
                  ...
                  <input
                    type="text"
                    className="cha-form-control cha-step2-4-take-time"
              ...
              <div className="cha-form-group">
                ...
                <input
                  type="text"
                  className="cha-form-control cha-step2-5-take-address-1"
              ...
              <div className="cha-form-group">
                ...
                <input
                  type="text"
                  className="cha-form-control cha-step2-5-take-address-2"
              ...
              <div className="cha-form-group">
                ...
                <input
                  type="text"
                  className="cha-form-control cha-step2-5-take-address-3"
          ...
          <div className="cha-main-card cha-main-card-step3">
            ...
            <form action="#" id="#">
              ...
              <div className="cha-form-group">
                ...
                <input
                  type="text"
                  className="cha-form-control cha-step3-1-card-number"
              ...
              <div className="cha-step3-MONTH-YEAR-3number">
                <div className="cha-form-group">
                  ...
                  <input
                    type="text"
                    className="cha-form-control cha-step3-2-MONTH"
                    id="step3-2-MONTH"
                    name="step3-2-MONTH"
                  />
                </div>
                ...
                <div className="cha-form-group">
                  ...
                  <input
                    type="text"
                    className="cha-form-control cha-step3-4-back-3number"
