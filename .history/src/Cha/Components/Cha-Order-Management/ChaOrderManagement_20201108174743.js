...
function ChaOrderManagement(props) {
  ...
  const TabMenu = () => {
    ...
    async function getMyOrderDetail(paramSOrderId) {
      ...
      setorderSidDetail(dataMyOrderDetail[0]);
      setproductSidDetail(dataMyOrderDetail[0]);
      setproductAmountDetail(dataMyOrderDetail[0]);
      setproductNameDetail(dataMyOrderDetail[0]);
      setproductPriceDetail(dataMyOrderDetail[0]);
