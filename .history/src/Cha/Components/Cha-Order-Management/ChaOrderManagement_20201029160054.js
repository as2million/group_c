...
function ChaOrderManagement(props) {
  ...
  const TabMenu = () => {
    ...
    const tabContentA = (e) => {
      setTabActive(e.target, '.cha-order-mana-title');
      ...
      <>
        <div className="cha-order-mana-content-container col-9">
          <div className="cha-order-mana-content-row1">
            <div
              className="cha-order-mana-title active"
              onClick={tabContentA}
            >
              未送達
            </div>
            <div className="cha-order-mana-title" onClick={tabContentB}>
              已送達
            </div>
            <div className="cha-order-mana-title" onClick={tabContentC}>
              已退費
            </div>
            <div className="cha-order-mana-title" onClick={tabContentD}>
              揪團中
            </div>
          </div>
