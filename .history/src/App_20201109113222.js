...
function App() {
  ...
  const handleAddCartNumber = () => {
    ...
    const currentCart = JSON.parse(localStorage.getItem('cartNumber')) || [];
    setCartNumbers(cartNumber + 1);
  };
  // useEffect(() => {}, [cartNumber]);
      ...
      <>
        ...
        <Switch>
          ...
          <Route exact path="/cart">
            <ChaCart setShowBar={setShowBar} showBar={showBar} />
          </Route>
          {/* 揪團 */}
