    ...
    <>
      <div className="cha-main-card cha-main-card-step3">
        ...
        <form action="#" id="#">
          ...
          <div className="cha-step3-5-receipt-choose">
            ...
            <div className="cha-step3-5-receipt-div">
              <div className="">
                <input
                  className=""
                  id="cha-receipt-type_1"
                  name="cha-receipt-type"
                  type="radio"
                  value="1"
                />
                <label className="" htmlFor="cha-receipt-type_1">
                  發票捐贈
                </label>
              </div>
              <div className="">
                <input
                  className=""
                  id="cha-receipt-type_2"
                  name="cha-receipt-type"
                  type="radio"
                  value="2"
                />
                <label className="" htmlFor="cha-receipt-type_2">
                  二聯式電子發票
                </label>
              </div>
              <div className="">
                <input
                  className=""
                  id="cha-receipt-type_3"
                  name="cha-receipt-type"
                  type="radio"
                  value="3"
                />
                <label className="" htmlFor="cha-receipt-type_3">
                  三聯式電子發票
                </label>
              </div>
            </div>
          ...
          <div className="form-group">
            <label htmlhtmlFor="cha-step3-5-1charitable">愛心碼</label>
            <input
              type="text"
              className="form-control cha-step3-4-back-3number"
              id="cha-step3-4-back-3number"
          ...
          <div className="form-group">
            <label htmlhtmlFor="cha-step3-4-back-3number">愛心碼</label>
            <input
              type="text"
              className="form-control cha-step3-4-back-3number"
              id="cha-step3-4-back-3number"
