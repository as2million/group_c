            ...
            <form action="#" id="c#">
              ...
              {/* <div className="form-group-l-1">
                <div className="cha-H-box-5">
                  ...
                  <div className="form-group-l-1">
                    <select className="cha-s1 s3" id="ccard_type" name="card_type">
