...
function ChaCartProgressBar(props) {
  return (
    <>
      ...
      <div className="cha-progress-bar-yellow"><div className="cha-progress-bar-arrow-header-white"> <div className="cha-right-arrow"></div>
    
        <div className="cha-progress-bar-header">建立訂單</div></div>
